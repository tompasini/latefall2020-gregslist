                    ...
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" value="${this.bedrooms}" name="bedrooms" id="bedrooms"
                                        placeholder="">
                                </div>
                                <label for="bathrooms" class="col-sm-12 col-form-label">Bathrooms</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" value="${this.bathrooms}" name="bathrooms" id="bathrooms"
                                        placeholder="">
                                </div>
                                <label for="levels" class="col-sm-12 col-form-label">Levels</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" value="${this.levels}" name="levels" id="levels"
                                        placeholder="">
                                </div>
